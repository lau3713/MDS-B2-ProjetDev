...
function Restaurants () {
  ...
  // Méthode du cycle de vie d'un composant React permettant d'effectuer une action au montage(apparition sur la page) du composant
  ...
  return (
    <>
      ...
      <div className='list'>
        {
            // On vérifie qu'on a bien récupéré les restaurants
            ...
            restaurants && restaurants.map(restaurant => {
              return (
                <Card key={restaurant} restaurant={restaurant} />
              )
            })
          }
